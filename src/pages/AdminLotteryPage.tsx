...
import { Armchair, BarChart3, DoorOpen, LayoutDashboard, LogOut, RefreshCw, Search, ShieldCheck, Users } from 'lucide-react';
...
const tabs = ['dashboard', 'counter', 'private', 'table', 'results', 'history'] as const;
type Tab = (typeof tabs)[number];
const tabLabels = { dashboard: '運用ダッシュボード', counter: 'カウンター', private: '個室', table: 'テーブル席', results: '抽選結果', history: '操作履歴' };
