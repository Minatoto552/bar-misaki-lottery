...
export const BrandMark = ({ size = 'md' }: { size?: 'sm' | 'md' | 'lg' }) => {
  ...
  return <img alt="BarMisaki" className={`${sizes[size]} rounded-full border border-white/60 bg-white object-cover shadow-[0_4px_18px_rgba(25,40,55,0.16)]`} src={`${import.meta.env.BASE_URL}bar-misaki-mark.png`} />;
};
